...
It works like a regular chat, so it's easier to use because there's less resistance. We used to send memes to friends, now we send notes to bots. We reuse all-too-familiar pattern for the greater good.  
